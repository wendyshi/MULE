 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Weihang Shi");
		  toPrint += p1.toString("wshi43");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Zheng Wu");
		  toPrint += p2.toString("902915186");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Don Geldbach");
		  toPrint += p3.toString("dgeldbach3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Lei Qifasdfasf");
                  toPrint += p4.toString("lqi34");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Tengfei Lin");
                  toPrint += p5.toString("tlin314");
